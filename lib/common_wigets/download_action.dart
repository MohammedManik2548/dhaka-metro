...
class DownloadAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 35,
      width: size,
      decoration: BoxDecoration( borderRadius: corner=='left'?BorderRadius.only(bottomLeft:Radius.circular(10)):corner=='right'?BorderRadius.only(bottomRight:Radius.circular(10)):BorderRadius.only(topLeft:Radius.circular(0))),
      child: InkWell(
        onTap: callback,
        child: Container(
