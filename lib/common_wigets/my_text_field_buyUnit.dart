...
class MyTextFieldBuyUnit extends StatelessWidget {
  late TextEditingController editingController;
  late bool enableOrDisable;
  late String hints;
  ...
  // PurchaseController _controller=Get.put(PurchaseController());
    ...
    return  Container(
      ...
      child: TextFormField(
        ...
        onChanged: (v){
          ...
          // _controller.amountCalculation(_controller.buyUBOAccountNo.text);
