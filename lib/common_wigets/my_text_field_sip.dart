...
class MyTextFieldSip extends StatelessWidget {
  ...
  // CreateNewSipController _controller=Get.put(CreateNewSipController());
    ...
    return  Container(
      ...
      child: TextFormField(
        ...
        onChanged: (v){
          ...
          // _controller.investmentAmount.value='$v';
          // _controller.investorBalance.value='$v';
