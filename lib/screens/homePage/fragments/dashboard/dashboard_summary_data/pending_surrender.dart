class PendingSurrender {
  ...
  PendingSurrender.fromJson(dynamic json) {
  ...
  dynamic dddate;
  dynamic sendtobank;
  dynamic honordishonorcancel;
  dynamic unitactivate;
  dynamic unitactivatedate;
  dynamic accountdetailsid;
  dynamic orgid;
  String? serialno;
  dynamic prefix;
  dynamic realno;
  dynamic centralserialno;
  String? sellsurrflag;
