...
import 'fund_bank_account_info_result.dart';
...
class SummaryDetailsData {
  ...
  SummaryDetailsData.fromJson(dynamic json) {
   ...
   investor = json['investor'] != null ? Investor.fromJson(json['investor']) : null;
    ...
    investorPortfolioStatement = json['investorPortfolioStatement'] != null ? InvestorPortfolioStatement.fromJson(json['investorPortfolioStatement']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (lastFiveTransactions != null) {
      map['lastFiveTransactions'] = lastFiveTransactions?.map((v) => v.toJson()).toList();
    }
